    ...
    try:
        ...
        if team_name:
            ...
            try:
                ...
                if team_obj.league or team_obj.division:
                    league_info = f"Regarding our {team_obj.league}"
                    if team_obj.division:
                        league_info += f" ({team_obj.division})"
                    league_info += " match:"
                    response_parts.append(league_info)
